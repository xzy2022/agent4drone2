...
class UAVAPIClient:
    ...
    This client provides a clean interface to all UAV operations including
    drone control, session management, environment queries, and safety checks.
    """
    ...
    def take_off(self, drone_id: str, altitude: float = 10.0) -> Dict[str, Any]:
        ...
        return self._request('POST', f'/drones/{drone_id}/command/take_off',
